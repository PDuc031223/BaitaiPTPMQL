...
namespace DemoMVC.Controllers
{
    public class HeThongPhanPhoiController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id")] HeThongPhanPhoi heThongPhanPhoi)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id")] HeThongPhanPhoi heThongPhanPhoi)
        {
        ...
        {
            return _context.HeThongPhanPhoi_1.Any(e => e.Id == id);
        }
    }
}
